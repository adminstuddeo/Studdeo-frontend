  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-3xl font-bold text-gray-800">Gestión de Profesores</h2>
        ...
        <table className="w-full">
          <thead className="bg-gray-50 border-b-2 border-gray-200">
            <tr>
              ...
              <th className="px-6 py-4 text-left text-sm font-semibold text-gray-700">Clases Asignadas</th>
